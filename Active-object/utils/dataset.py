...
batch_size = 100
PATH="D:\Active-Object-Localization-Deep-Reinforcement-Learning-master\datas"
...
def read_voc_dataset(download=True, year='2007'):
    ...
    voc_data =  torchvision.datasets.VOCDetection(PATH, year=year, image_set='trainval', 
                        download=download, transform=T)
    train_loader = DataLoader(voc_data,shuffle=True)

    voc_val =  torchvision.datasets.VOCDetection(PATH, year=year, image_set='test', 
                        download=download, transform=T)
